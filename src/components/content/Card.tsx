...
export function Card({ icon, index }: { icon: Item; index: number }) {
	return (
		<article
			key={index}
			className='outline outline-[#f1f1f155] outline-[0.1px] text-[#f1f1f1ee] rounded-md w-full px-5 py-5 flex flex-col items-center cursor-pointer justify-center gap-3 bg-[rgb(11,11,11)] max-w-[500px] group relative overflow-y-hidden '
		>
			<img
				src={icon.img}
